...
pub use geometry::{
    Anchor, ArrowGeom, Cap, Crossing, Drawn, Geometry, GeometryOptions, LabelGeom, LabelOwner, LabelSizes,
    LabelText, LineGeom, LineKind, LineStyle, Patch, Path, Piece, PlaneGeom, Shape, TensorGeom, View,
    geometry,
};
